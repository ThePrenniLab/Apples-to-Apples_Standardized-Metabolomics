...
# Load the datasets
dataset1 <- read.csv("LabA-pos-cleaned-noisomer-1-wheat-flour.csv")
dataset2 <- read.csv("LabB-pos-cleaned-noisomer-1-wheat-flour.csv")
dataset3 <- read.csv("LabC-pos-cleaned-noisomer-1-wheat-flour.csv")
...
write.csv(df, "wheat-flour_cleaned-RI10.csv", row.names = FALSE)
