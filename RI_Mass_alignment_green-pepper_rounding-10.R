...
# Load the datasets
dataset1 <- read.csv("LabA-pos-GGB100010-noisomer-1.csv")
dataset2 <- read.csv("LabB-pos-GGB100010-noisomer-1.csv")
dataset3 <- read.csv("LabC-pos-GGB100010-noisomer-1.csv")
...
write.csv(df, "greenpepper_cleaned_10RI.csv", row.names = FALSE)
