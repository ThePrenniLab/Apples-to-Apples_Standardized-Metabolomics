...
# Load the datasets
dataset1 <- read.csv("LabA-pos-cleaned-noisomer-1-carrotref.csv")
dataset2 <- read.csv("LabB-pos-cleaned-noisomer-1-carrotref.csv")
dataset3 <- read.csv("LabC-pos-cleaned-noisomer-1-carrotref.csv")
...
write.csv(df, "carrot-ref_cleaned-RI10.csv", row.names = FALSE)
