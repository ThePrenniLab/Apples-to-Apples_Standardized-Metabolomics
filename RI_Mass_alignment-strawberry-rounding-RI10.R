...
# Load the datasets
dataset1 <- read.csv("LabA-pos-cleaned-noisomer-1-strawberry.csv")
dataset2 <- read.csv("LabB-pos-cleaned-noisomer-1-strawberry.csv")
dataset3 <- read.csv("LabC-pos-cleaned-noisomer-1-strawberry.csv")
...
write.csv(df, "strawberry_cleaned-RI10.csv", row.names = FALSE)
